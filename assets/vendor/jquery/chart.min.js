...
(function () {
  ...
  function Ta(k, m, w) {
    "millisecond" === w
      ...
      : "year" === w && k.setFullYear(k.getFullYear() + 1 * m);
    return k;
  }
  function $(k, m) {
    var w = !1;
  ...
  function Da(k) {
    if (!k) return k;
    k = k.replace(/^\s\s*/, "");
    for (var m = /\s/, w = k.length; m.test(k.charAt(--w)); );
    return k.slice(0, w + 1);
  }
  function za(k) {
    k.roundRect = function (k, w, s, u, pa, D, y, E) {
      ...
      this.beginPath();
      this.moveTo(k + pa, w);
      this.lineTo(k + s - pa, w);
      this.quadraticCurveTo(k + s, w, k + s, w + pa);
      this.lineTo(k + s, w + u - pa);
      this.quadraticCurveTo(k + s, w + u, k + s - pa, w + u);
      this.lineTo(k + pa, w + u);
      this.quadraticCurveTo(k, w + u, k, w + u - pa);
      this.lineTo(k, w + pa);
      this.quadraticCurveTo(k, w, k + pa, w);
      this.closePath();
      y && this.fill();
      E && 0 < D && this.stroke();
    };
  ...
  function Ua(k, m, w) {
    ...
    if (isNaN(u)) {
      try {
        ...
        ua.style.display = "";
        ua.setAttribute("style", k);
        u = Math.round(ua.offsetHeight);
  ...
  function V(k, m, w, u, y) {
    u = u || [];
    y = s(y) ? (db ? { passive: !1, capture: !1 } : !1) : y;
    u.push([k, m, w, y]);
    return k.addEventListener
      ? (k.addEventListener(m, w, y), w)
      : k.attachEvent
      ? ((u = function (m) {
          m = m || window.event;
          m.preventDefault =
        ...
        k.attachEvent("on" + m, u),
        u)
      : !1;
  }
  function eb(k) {
    if (k._menuButton) k.exportEnabled ? Ia(k._menuButton) : sa(k._menuButton);
    else if (k.exportEnabled && u) {
      var m = !1;
      k._menuButton = document.createElement("button");
      ta(k, k._menuButton, "menu");
        ...
        function () {
          m ||
            ...
            0 >= navigator.userAgent.search("MSIE") &&
              na(k, k._menuButton.childNodes[0], {
    ...
    if (!k._dropdownMenu && k.exportEnabled && u) {
      ...
      var w = -1 !== k.theme.indexOf("dark") ? "black" : "#888888";
      ...
      w.innerHTML = k._cultureInfo.printText;
      w.style.backgroundColor = k.toolbar.backgroundColor;
      w.style.color = k.toolbar.fontColor;
      k._dropdownMenu.appendChild(w);
      V(
        w,
        "touchstart",
        function (k) {
      ...
      w = document.createElement("div");
      w.style.cssText = "padding: 12px 8px 12px 8px";
      w.innerHTML = k._cultureInfo.saveJPGText;
      w.style.backgroundColor = k.toolbar.backgroundColor;
      w.style.color = k.toolbar.fontColor;
      k._dropdownMenu.appendChild(w);
      V(
      ...
      w = document.createElement("div");
      w.style.cssText = "padding: 12px 8px 12px 8px";
      w.innerHTML = k._cultureInfo.savePNGText;
      w.style.backgroundColor = k.toolbar.backgroundColor;
      w.style.color = k.toolbar.fontColor;
      k._dropdownMenu.appendChild(w);
      V(
  ...
  function Wa(k, m, w) {
    k *= ga;
    m *= ga;
    k = w.getImageData(k, m, 2, 2).data;
    m = !0;
    for (w = 0; 4 > w; w++)
      if ((k[w] !== k[w + 4]) | (k[w] !== k[w + 8]) | (k[w] !== k[w + 12])) {
        m = !1;
        break;
      }
  ...
  function Ja(k, m, w) {
    if (u && Xa) {
      ...
      Oa !== Ka &&
        ...
        (k.style.height = w + "px"),
        s.scale(ga, ga));
    } else (k.width = m), (k.height = w);
  }
  function fb(k) {
    if (!gb) {
      var m = !1,
        w = !1;
      "undefined" === typeof oa.Chart.creditHref
        ? ((k.creditHref = Y("iuuqr;..b`ow`rkr/bnl.")),
          (k.creditText = Y("B`ow`rKR/bnl")))
        : ((m = k.updateOption("creditText")),
          (w = k.updateOption("creditHref")));
  ...
  function ta(k, m, w) {
    ...
    m.getAttribute("state") !== w &&
      ...
      m.setAttribute("title", k._cultureInfo[w + "Text"]),
      (m.innerHTML =
        "<img style='height:95%; pointer-events: none;' src='" +
        hb[w].image +
        "' alt='" +
        k._cultureInfo[w + "Text"] +
        "' />"));
  }
  function Ia() {
  ...
  function Pa(k, m, w, s, u) {
    if (null === k || "undefined" === typeof k)
      return "undefined" === typeof w ? m : w;
    k =
      parseFloat(k.toString()) * (0 <= k.toString().indexOf("%") ? m / 100 : 1);
    "undefined" !== typeof s &&
      ((k = Math.min(s, k)), "undefined" !== typeof u && (k = Math.max(u, k)));
    return !isNaN(k) && k <= m && 0 <= k ? k : "undefined" === typeof w ? m : w;
  }
  function W(k, m, w, u, y) {
    this._defaultsKey = k;
      ...
      : this.parent &&
        ...
        (null === u
          ...
          : 0 < this.parent.themeOptions[m].length &&
            ((u = Math.min(this.parent.themeOptions[m].length - 1, u)),
            (k = this.parent.themeOptions[m][u])));
    this.themeOptions = k;
  ...
  function Qa(k, m) {
    Qa.base.constructor.call(this, "Toolbar", "toolbar", m, null, k);
    this.chart = k;
  ...
  function wa(k, m) {
    wa.base.constructor.call(this, "Title", "title", m, null, k);
    this.chart = k;
    this.canvas = k.canvas;
    this.ctx = this.chart.ctx;
    this.optionsName = "title";
    if (s(this.options.margin) && k.options.subtitles)
      for (var w = k.options.subtitles, u = 0; u < w.length; u++)
        if (
          ((s(w[u].horizontalAlign) && "center" === this.horizontalAlign) ||
            w[u].horizontalAlign === this.horizontalAlign) &&
          ((s(w[u].verticalAlign) && "top" === this.verticalAlign) ||
            w[u].verticalAlign === this.verticalAlign) &&
  ...
  function Fa(k, m, w) {
    Fa.base.constructor.call(this, "Subtitle", "subtitles", m, w, k);
    this.chart = k;
    this.canvas = k.canvas;
    this.ctx = this.chart.ctx;
  ...
  function Ga(k) {
    var m;
    k && Ha[k] && (m = Ha[k]);
    Ga.base.constructor.call(this, "CultureInfo", null, m, null, null);
  }
  var Ea = !1,
    J = {},
    ...
    Ca = u ? "Impact, Charcoal, sans-serif" : "Arial",
    xa = {
  ...
  (function () {
    J.fSDec = function (k) {
      for (var m = "", w = 0; w < k.length; w++)
        m += String.fromCharCode(
          Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(w)
        );
      return m;
    };
    J.obj = {
    ...
    delete oa[J.fSDec("Bi`su")][J.fSDec("bsdehuIsdg")];
    J.pro = { sCH: oa[J.fSDec("Bi`su")][J.fSDec("bsdehuIsdg")] };
    J._fTWm = function (k) {
      if ("undefined" === typeof J.pro.sCH && !$a)
        try {
  ...
  var db = (function () {
        ...
        if (((m = E[L]), "." === m && 0 > N)) N = L;
          ...
          if ("%" === m) D *= 100;
            ...
            ("E" !== m[0] && "e" !== m[0]) ||
              ...
              (Q = !0);
          0 > N
            ? (M.push(m), "#" === m || "0" === m ? P++ : "," === m && V++)
            : (I.push(m), ("#" !== m && "0" !== m) || J++);
        }
      Q &&
        ((m = Math.floor(k)),
        (E = -Math.floor(Math.log(k) / Math.LN10 + 1)),
        (W = 0 === k ? 0 : 0 === m ? -(P + E) : String(m).length - P),
        (D /= Math.pow(10, W)));
      0 > N && (N = L);
      D = (k * D).toFixed(J);
      m = D.split(".");
        ...
        if (((m = M.pop()), "#" === m || "0" === m))
          if ((N++, N === P)) {
            ...
            for (; 0 < X.length; )
              (w = X.pop() + w),
                Q++,
                0 === Q % E && L === V && 0 < X.length && (w = y + w);
          } else
            0 < D.length
              ? ((w = D.pop() + w), J++, Q++)
              : "0" === m && ((w = "0" + w), J++, Q++),
              0 === Q % E && L === V && 0 < D.length && (w = y + w);
        else
          ("E" !== m[0] && "e" !== m[0]) ||
          "0" !== m[m.length - 1] ||
          !/[eE][+-]*[0]+/.test(m)
            ? "," === m
              ? (L++, (E = Q), (Q = 0), 0 < D.length && (w = y + w))
              : (w =
                  1 < m.length &&
                  (('"' === m[0] && '"' === m[m.length - 1]) ||
                    ("'" === m[0] && "'" === m[m.length - 1]))
    ...
    La = function (k) {
      ...
      k.offsetX || 0 === k.offsetX
        ? ((m = k.offsetX), (w = k.offsetY))
        : k.layerX || 0 == k.layerX
        ? ((m = k.layerX), (w = k.layerY))
        : ((m = k.pageX - k.target.offsetLeft),
          (w = k.pageY - k.target.offsetTop));
      return { x: m, y: w };
    },
    Xa = !0,
    ...
    Ka = 1,
    ga = Xa ? Oa / Ka : 1,
    ca = function (k, m, w, s, u, y, D, E, N, M, Q, P, I) {
      ...
      0 < D &&
        ...
        (k.strokeStyle = E),
        k.moveTo(m, w),
        k.rect(m - I, w - I, s - m + 2 * I, u - w + 2 * I),
        k.stroke());
      k.restore();
      !0 === N &&
        (k.save(),
        ...
        k.lineTo(s, w),
        k.closePath(),
        (D = k.createLinearGradient((s + m) / 2, w + J, (s + m) / 2, w)),
        D.addColorStop(0, y),
      ...
      !0 === M &&
        ...
        k.lineTo(s, u),
        k.closePath(),
        (D = k.createLinearGradient((s + m) / 2, u - J, (s + m) / 2, u)),
        D.addColorStop(0, y),
        D.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (k.fillStyle = D),
        k.fill(),
      ...
      !0 === Q &&
        ...
        k.lineTo(m, u),
        k.closePath(),
        (D = k.createLinearGradient(m + J, (u + w) / 2, m, (u + w) / 2)),
        D.addColorStop(0, y),
      ...
      !0 === P &&
        ...
        k.lineTo(s - J, u - J),
        k.lineTo(s, u),
        (D = k.createLinearGradient(s - J, (u + w) / 2, s, (u + w) / 2)),
        D.addColorStop(0, y),
        D.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (k.fillStyle = D),
        D.addColorStop(0, y),
    ...
    gb = $a && -1 === window[Y("mnb`uhno")].href.indexOf(Y("gheemd")),
    hb = {
      reset: {
        image:
  ...
  W.prototype.setOptions = function (k, m) {
    if (oa[this._defaultsKey]) {
      var s = oa[this._defaultsKey],
        u;
      for (u in s)
        "publicProperties" !== u &&
          s.hasOwnProperty(u) &&
          (this[u] = k && u in k ? k[u] : m && u in m ? m[u] : s[u]);
    } else Ea && window.console && console.log("defaults not set");
  };
  ...
  W.prototype.addTo = function (k, m, s, u) {
    ...
    var y = oa[this._defaultsKey];
    y.hasOwnProperty(k) ||
    (y.publicProperties &&
      y.publicProperties.hasOwnProperty(k) &&
      "readWrite" === y.publicProperties[k])
      ? (this.options._isPlaceholder && this.createUserOptions(),
    ...
    if ("undefined" !== typeof k || this.options._isPlaceholder)
      if (
        ...
        var m = this.parent.options[this.optionsName],
          s = m.length;
        this.options._isPlaceholder || (Aa(m), (s = m.indexOf(this.options)));
  ...
  W.prototype.updateOption = function (k) {
    ...
    var m = oa[this._defaultsKey],
      ...
      J = this._index;
    this.theme && s(this.parent) && s(E) && s(J)
      ? (u = s(this.predefinedThemes[this.theme])
          ? this.predefinedThemes.light1
          : this.predefinedThemes[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        ...
        (null === J
          ? (u = this.parent.themeOptions[E])
          : 0 < this.parent.themeOptions[E].length &&
            ((u = Math.min(this.parent.themeOptions[E].length - 1, J)),
            (u = this.parent.themeOptions[E][u])));
    this.themeOptions = u;
    k in m &&
      (y = k in this.options ? this.options[k] : u && k in u ? u[k] : m[k]);
  ...
  W.prototype.addEventListener = function (k, m, s) {
    k &&
      ...
      this._eventListeners[k].push({ context: s || this, eventHandler: m }));
  };
  ...
  W.prototype.dispatchEvent = function (k, m, s) {
    if (k && this._eventListeners[k]) {
      m = m || {};
      for (var u = this._eventListeners[k], y = 0; y < u.length; y++)
        u[y].eventHandler.call(u[y].context, m);
    }
    "function" === typeof this[k] && this[k].call(s || this.chart, m);
  };
  Ba.prototype.registerSpace = function (k, m) {
    "top" === k
  ...
  Ba.prototype.unRegisterSpace = function (k, m) {
    "top" === k
      ? (this._topOccupied -= m.height)
      : "bottom" === k
      ? (this._bottomOccupied -= m.height)
      ...
      for (s = 0; s < this._wrappedText.lines.length; s++)
        (E = this._wrappedText.lines[s]),
          "right" === this.horizontalAlign
            ? (u = this.width - E.width - this.rightPadding)
  ...
  ia.prototype._wrapText = function () {
    var k = new String(Da(String(this.text))),
      m = [],
      s = this.ctx.font,
      u = 0,
      y = 0;
    ...
    if (0 === this.frontSize) y = u = 0;
      ...
      for (; 0 < k.length; ) {
        ...
        var J = y,
          ...
          u = u + D.height,
          k = Da(k.slice(D.text.length, k.length));
  ...
  ma(Qa, W);
  ma(wa, W);
  wa.prototype.setLayout = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((y = m.y2 - 2 - M.height), (I = "bottom")),
          "left" === this.horizontalAlign
            ? (u = m.x1 + 2)
            : "center" === this.horizontalAlign
            ? (u = m.x1 + m.width / 2 - M.width / 2)
            : "right" === this.horizontalAlign && (u = m.x2 - 2 - M.width - D),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ...
            ? ((u = m.x2 - 2),
              ...
              (this.height = M.width))
            : "center" === this.horizontalAlign &&
              ((y = k.y1 + (k.height / 2 - M.height / 2)),
              (u = k.x1 + (k.width / 2 - M.width / 2)),
              (I = "center"),
              (this.width = M.width),
              (this.height = M.height)),
          (N = "center"));
  ...
  ma(Fa, W);
  Fa.prototype.setLayout = wa.prototype.setLayout;
  Fa.prototype.render = wa.prototype.render;
  Ra.prototype.get = function (k, m) {
    var u = null;
    0 < this.pool.length
      ? ((u = this.pool.pop()), Ja(u, k, m))
      : (u = ra(k, m));
    return u;
  };
  Ra.prototype.release = function (k) {
    this.pool.push(k);
  };
  ma(Ga, W);
  var Ma = {
    ...
    formatNumber: function (k, m, u) {
      u = u || "en";
      if (Ha[u]) return ea(k, m || "#,##0.##", new Ga(u));
      throw "Unknown Culture Name";
    },
    formatDate: function (k, m, u) {
      u = u || "en";
      if (Ha[u]) return ya(k, m || "DD MMM YYYY", new Ga(u));
      throw "Unknown Culture Name";
    },
  };
  "undefined" !== typeof module && "undefined" !== typeof module.exports
    ...
    : (window.CanvasJS &&
      ...
      (window.CanvasJS = window.CanvasJS ? window.CanvasJS : Ma));
  y = Ma.Chart = (function () {
    function k(a, d) {
      return a.x - d.x;
    }
      ...
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          b =
            (Math.abs(
              (a[p].x - a[f].x) /
                (0 === a[p].x - a[l].x ? 0.01 : a[p].x - a[l].x)
            ) *
              (d - 1)) /
              2 +
            1;
          ...
          b = (a[p].y - a[f].y) / b;
          c[c.length] =
            (a[l].x > a[f].x && 0 < B) || (a[l].x < a[f].x && 0 > B)
              ? { x: a[l].x + B / 3, y: a[l].y + b / 3 }
              : { x: a[l].x, y: a[l].y + b / 9 };
          l = e;
          f = 0 === l ? 0 : l - 1;
          p = l === a.length - 1 ? l : l + 1;
          b =
            (Math.abs(
              (a[p].x - a[f].x) /
                (0 === a[l].x - a[f].x ? 0.01 : a[l].x - a[f].x)
            ) *
              (d - 1)) /
              2 +
            1;
    ...
    function y(a, d, c, b, e, f, p, l, B, h) {
      var n = 0;
      h ? ((p.color = f), (l.color = f)) : (h = 1);
      n = B ? Math.abs(e - c) : Math.abs(b - d);
      n =
        0 < p.trimLength
          ? Math.abs((n * p.trimLength) / 100)
          : Math.abs(n - p.length);
      ...
      a.beginPath();
      B && 0 < l.thickness
        ? (a.moveTo(b - p.thickness / 2, Math.round((c + e) / 2) - r),
          a.lineTo(d + p.thickness / 2, Math.round((c + e) / 2) - r))
        : 0 < l.thickness &&
          (a.moveTo(Math.round((d + b) / 2) - r, c + p.thickness / 2),
          a.lineTo(Math.round((d + b) / 2) - r, e - p.thickness / 2));
      a.stroke();
    ...
    m.prototype._updateOptions = function () {
      ...
      this._cultureInfo = new Ga(this.options.culture);
      ...
      if (this.options.zoomEnabled || this.panEnabled) {
        if (!this._zoomButton) {
          var d = !1;
          sa((this._zoomButton = document.createElement("button")));
        ...
        this._resetButton ||
          ((d = !1),
          sa((this._resetButton = document.createElement("button"))),
        ...
        this.zoomEnabled ||
          ...
          (this._zoomButton
            ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText
              ...
              Ia(a._zoomButton, a._resetButton))
            : ((this.zoomEnabled = !0), (this.panEnabled = !1)));
    ...
    m.prototype._updateSize = function () {
      ...
      if (this.canvas.width !== d * ga || this.canvas.height !== c * ga) {
        for (var b = 0; b < a.length; b++) Ja(a[b], d, c);
        this.bounds = {
          x1: 0,
          y1: 0,
          x2: this.width,
    ...
    m.prototype._initialize = function () {
      ...
      this._updateOptions();
      this.animatedRender =
        u && this.animationEnabled && 0 === this.renderCount;
      this._updateSize();
      this.clearCanvas();
      this.ctx.beginPath();
      this.axisX = [];
    ...
    m.prototype.setLayout = function () {
      ...
      c
        ? (Ia(this._zoomButton, this._resetButton),
      ...
      this._processData();
      this.options.title &&
        ((this.title = new wa(this, this.options.title)),
      ...
      if (this.options.subtitles)
        for (d = 0; d < this.options.subtitles.length; d++)
          (c = new Fa(this, this.options.subtitles[d], d)),
    ...
    m.prototype.renderElements = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          ...
          l.targetCanvas = null;
          this.animatedRender &&
            ((l.targetCanvas = ra(this.width, this.height)),
          ...
          "line" === l.type
            ? (B = this.renderLine(l))
            : "stepLine" === l.type
            ? (B = this.renderStepLine(l))
            : "spline" === l.type
            ? (B = this.renderSpline(l))
            : "column" === l.type
            ? (B = this.renderColumn(l))
            : "bar" === l.type
            ? (B = this.renderBar(l))
            : "area" === l.type
            ? (B = this.renderArea(l))
            : "stepArea" === l.type
            ? (B = this.renderStepArea(l))
            : "splineArea" === l.type
            ? (B = this.renderSplineArea(l))
            : "stackedColumn" === l.type
            ? (B = this.renderStackedColumn(l))
            : "stackedColumn100" === l.type
            ? (B = this.renderStackedColumn100(l))
            : "stackedBar" === l.type
            ? (B = this.renderStackedBar(l))
            : "stackedBar100" === l.type
            ? (B = this.renderStackedBar100(l))
            : "stackedArea" === l.type
            ? (B = this.renderStackedArea(l))
            : "stackedArea100" === l.type
            ? (B = this.renderStackedArea100(l))
            : "bubble" === l.type
            ? (B = B = this.renderBubble(l))
            : "scatter" === l.type
            ? (B = this.renderScatter(l))
            : "pie" === l.type
            ? this.renderPie(l)
            : "doughnut" === l.type
            ? this.renderPie(l)
            : "funnel" === l.type
            ? (B = this.renderFunnel(l))
            : "pyramid" === l.type
            ? (B = this.renderFunnel(l))
            : "candlestick" === l.type
            ? (B = this.renderCandlestick(l))
            : "ohlc" === l.type
            ? (B = this.renderCandlestick(l))
            : "rangeColumn" === l.type
            ? (B = this.renderRangeColumn(l))
            : "error" === l.type
            ? (B = this.renderError(l))
            : "rangeBar" === l.type
            ? (B = this.renderRangeBar(l))
            : "rangeArea" === l.type
            ? (B = this.renderRangeArea(l))
            : "rangeSplineArea" === l.type
            ? (B = this.renderRangeSplineArea(l))
            : "waterfall" === l.type
            ? (B = this.renderWaterfall(l))
            : "boxAndWhisker" === l.type && (B = this.renderBoxAndWhisker(l));
          for (var h = 0; h < l.dataSeriesIndexes.length; h++)
            this._dataInRenderedOrder.push(this.data[l.dataSeriesIndexes[h]]);
          this.animatedRender &&
            ((l.targetCanvasCtx.miterLimit = e), B && c.push(B));
        }
      ...
      if (0 < c.length)
        ...
        if (n._breaksCanvas)
          ...
          else for (h = 0; h < n._axes.length; h++) n._axes[h].createMask();
          ...
          if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement)
            var q = a.axisX.sessionVariables.newViewportMinimum
              ...
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (l.dataPoints[B].x && l.dataPoints[B].x.getTime) ||
            "dateTime" === l.xValueType
          )
            f = !0;
          for (B = 0; B < l.dataPoints.length; B++) {
            "undefined" === typeof l.dataPoints[B].x &&
              (l.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0));
            l.dataPoints[B].x.getTime
              ? ((f = !0), (b = l.dataPoints[B].x.getTime()))
              : (b = l.dataPoints[B].x);
            e = l.dataPoints[B].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            ...
            if (0 < B) {
              if (a.axisX.logarithmic) {
                var v = b / l.dataPoints[B - 1].x;
                1 > v && (v = 1 / v);
                c.minDiff > v && 1 !== v && (c.minDiff = v);
              } else
                (v = b - l.dataPoints[B - 1].x),
                  0 > v && (v *= -1),
                  c.minDiff > v && 0 !== v && (c.minDiff = v);
              null !== e &&
                null !== l.dataPoints[B - 1].y &&
                (a.axisY.logarithmic
                  ? ((v = e / l.dataPoints[B - 1].y),
                    1 > v && (v = 1 / v),
                    d.minDiff > v && 1 !== v && (d.minDiff = v))
                  : ((v = e - l.dataPoints[B - 1].y),
                    0 > v && (v *= -1),
            ...
            if (b < q && !h) null !== e && (r = b);
              ...
              l.dataPoints[B].label &&
                (a.axisX.labels[b] = l.dataPoints[B].label);
    ...
    m.prototype._processStackedPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          var r = this.data[a.dataSeriesIndexes[n]],
            q = 0,
            g = !1,
            v = !1,
            k;
          ...
          for (q = 0; q < r.dataPoints.length; q++) {
            ...
            if (0 < q) {
              if (a.axisX.logarithmic) {
                var x = b / r.dataPoints[q - 1].x;
                1 > x && (x = 1 / x);
                c.minDiff > x && 1 !== x && (c.minDiff = x);
              } else
                (x = b - r.dataPoints[q - 1].x),
                  0 > x && (x *= -1),
          ...
          if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement)
            var k = a.axisX.sessionVariables.newViewportMinimum
              ...
              m = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (n.dataPoints[r].x && n.dataPoints[r].x.getTime) ||
            "dateTime" === n.xValueType
          )
            f = !0;
          for (r = 0; r < n.dataPoints.length; r++) {
            "undefined" === typeof n.dataPoints[r].x &&
              (n.dataPoints[r].x = r + (a.axisX.logarithmic ? 1 : 0));
            n.dataPoints[r].x.getTime
              ? ((f = !0), (b = n.dataPoints[r].x.getTime()))
              : (b = n.dataPoints[r].x);
            ...
            if (0 < r) {
              if (a.axisX.logarithmic) {
                ...
                (t = b - n.dataPoints[r - 1].x),
                  0 > t && (t *= -1),
                  c.minDiff > t && 0 !== t && (c.minDiff = t);
              s(e) ||
                null === n.dataPoints[r - 1].y ||
                (a.axisY.logarithmic
                  ? 0 < e &&
                    ((t = e / n.dataPoints[r - 1].y),
                    1 > t && (t = 1 / t),
            ...
            if (b < k && !q) null !== e && (v = b);
              ...
              n.dataPoints[r].label &&
                (a.axisX.labels[b] = n.dataPoints[r].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === e
    ...
    m.prototype._processMultiYPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          ...
          var h = this.data[a.dataSeriesIndexes[B]],
            n = 0,
            r = !1,
            q = !1,
            g,
          ...
          if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement)
            var m = a.axisX.sessionVariables.newViewportMinimum
              ...
              t = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (h.dataPoints[n].x && h.dataPoints[n].x.getTime) ||
            "dateTime" === h.xValueType
          )
            l = !0;
          for (n = 0; n < h.dataPoints.length; n++) {
            "undefined" === typeof h.dataPoints[n].x &&
              (h.dataPoints[n].x = n + (a.axisX.logarithmic ? 1 : 0));
            h.dataPoints[n].x.getTime
              ? ((l = !0), (b = h.dataPoints[n].x.getTime()))
              : (b = h.dataPoints[n].x);
            ...
            0 < n &&
              ...
              e &&
                null !== e[0] &&
                h.dataPoints[n - 1].y &&
                null !== h.dataPoints[n - 1].y[0] &&
                (a.axisY.logarithmic
                  ? ((v = e[0] / h.dataPoints[n - 1].y[0]),
                    1 > v && (v = 1 / v),
                    d.minDiff > v && 1 !== v && (d.minDiff = v))
                  : ((v = e[0] - h.dataPoints[n - 1].y[0]),
                    0 > v && (v *= -1),
            ...
            if (!(b < m) || r) {
              ...
              h.dataPoints[n].label &&
                (a.axisX.labels[b] = h.dataPoints[n].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            f = !0;
          for (B = 0; B < l.dataPoints.length; B++)
            "undefined" !== typeof l.dataPoints[B].isCumulativeSum &&
            !0 === l.dataPoints[B].isCumulativeSum
              ? ((l.dataPointEOs[B].cumulativeSumYStartValue = 0),
                (l.dataPointEOs[B].cumulativeSum =
                  0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum),
                (l.dataPoints[B].y =
                  0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum))
              : "undefined" !== typeof l.dataPoints[B].isIntermediateSum &&
                !0 === l.dataPoints[B].isIntermediateSum
              ? ((l.dataPointEOs[B].cumulativeSumYStartValue = r),
                (l.dataPointEOs[B].cumulativeSum =
                  0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum),
                (l.dataPoints[B].y = 0 === B ? 0 : b),
                (r = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum),
                (b = 0))
              : ((e =
                  "number" !== typeof l.dataPoints[B].y
                    ? 0
                    : l.dataPoints[B].y),
                (l.dataPointEOs[B].cumulativeSumYStartValue =
                  0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum),
                (l.dataPointEOs[B].cumulativeSum =
                  0 === B ? e : l.dataPointEOs[B - 1].cumulativeSum + e),
                (b += e));
          for (B = 0; B < l.dataPoints.length; B++)
            if (
              ("undefined" === typeof l.dataPoints[B].x &&
              ...
              b < c.min && (c.min = b),
              b > c.max && (c.max = b),
              l.dataPointEOs[B].cumulativeSum < d.min &&
                (d.min = l.dataPointEOs[B].cumulativeSum),
              l.dataPointEOs[B].cumulativeSum > d.max &&
                (d.max = l.dataPointEOs[B].cumulativeSum),
              0 < B &&
                (a.axisX.logarithmic
                  ? ((r = b / l.dataPoints[B - 1].x),
                    1 > r && (r = 1 / r),
                ...
                null !== e &&
                  ...
                  (a.axisY.logarithmic
                    ? ((e =
                        l.dataPointEOs[B].cumulativeSum /
                        l.dataPointEOs[B - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
              ...
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < B &&
                (l.dataPointEOs[B - 1].cumulativeSum < d.viewPortMin &&
                  (d.viewPortMin = l.dataPointEOs[B - 1].cumulativeSum),
                l.dataPointEOs[B - 1].cumulativeSum > d.viewPortMax &&
                  (d.viewPortMax = l.dataPointEOs[B - 1].cumulativeSum));
              l.dataPointEOs[B].cumulativeSum < d.viewPortMin &&
                (d.viewPortMin = l.dataPointEOs[B].cumulativeSum);
              l.dataPointEOs[B].cumulativeSum > d.viewPortMax &&
                (d.viewPortMax = l.dataPointEOs[B].cumulativeSum);
            }
          l.axisX.valueType = l.xValueType = f ? "dateTime" : "number";
        }
    };
    m.prototype.calculateAutoBreaks = function () {
                ...
                for (r = 0; r < k.dataPoints.length; r++)
                  if (
                    ...
                    if (
                      (g =
                        "waterfall" === a.type
                          ? k.dataPointEOs[r].cumulativeSum
                          : k.dataPoints[r].y) &&
                      g.length
                    )
                      for (var u = 0; u < g.length; u++)
                        (q = Math.floor((g[u] - l) / m)),
                          g[u] < d[q].min && (d[q].min = g[u]),
                          g[u] > d[q].max && (d[q].max = g[u]);
                    else
                      s(g) ||
                        ((q = Math.floor((g - l) / m)),
                        g < d[q].min && (d[q].min = g),
      ...
      if (f) {
        for (p = 0; p < this.plotInfo.plotTypes.length; p++)
          for (
            f = this.plotInfo.plotTypes[p], l = 0;
          ...
          if (this._axes[p].dataInfo._dataRanges) {
            ...
            for (l = 0; l < h.length - 1; l++)
              if (((n = h[l].max), isFinite(n)))
                for (; l < h.length - 1; )
                  if (((B = h[l + 1].min), isFinite(B))) {
                    r = B - n;
                    r > b && f.push({ diff: r, start: n, end: B });
                    break;
                  } else l++;
            if (this._axes[p].scaleBreaks.customBreaks)
              for (
                l = 0;
                l < this._axes[p].scaleBreaks.customBreaks.length;
                l++
              )
                for (b = 0; b < f.length; b++)
                  if (
                    (this._axes[p].scaleBreaks.customBreaks[l].startValue <=
                      f[b].start &&
                      f[b].start <=
                        this._axes[p].scaleBreaks.customBreaks[l].endValue) ||
                    (this._axes[p].scaleBreaks.customBreaks[l].startValue <=
                      f[b].start &&
                      f[b].start <=
                        this._axes[p].scaleBreaks.customBreaks[l].endValue) ||
    ...
    m.prototype.getObjectAtXY = function (a, d, c) {
      ...
      else if (u) b = Wa(a, d, this._eventManager.ghostCtx);
      else
    ...
    m.prototype.getAutoFontSize = jb;
    m.prototype.resetOverlayedCanvas = function () {
      this.overlaidCanvasCtx.clearRect(0, 0, this.width, this.height);
    };
    m.prototype.clearCanvas = ib;
      ...
      m.capturedEventParam &&
        ...
        b.hasOwnProperty(c) &&
          ("mouseup" !== c || b.chart.overlaidCanvas.releaseCapture
            ? (a.target !== b.chart.overlaidCanvas && u) ||
      ...
      if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
        ...
        if (
          ...
          if (this.panEnabled)
            ...
            this.overlaidCanvasCtx.fillRect(b, l, B, h);
    ...
    m.prototype.validateRegion = function (a, d, c, b, e) {
      ...
      for (
        ...
        (("axisX" === this._axes[r].type && f) ||
          ("axisY" === this._axes[r].type && p)) &&
          h.push(this._axes[r]);
      for (p = 0; p < h.length; p++) {
        ...
        if (q > g)
          var v = g,
            ...
            q = v;
        if (r.scaleBreaks)
          for (v = 0; !f && v < r.scaleBreaks._appliedBreaks.length; v++)
            f =
              r.scaleBreaks._appliedBreaks[v].startValue <= q &&
              r.scaleBreaks._appliedBreaks[v].endValue >= g;
        if (isFinite(r.dataInfo.minDiff))
          if (
            ((v = r.getApparentDifference(q, g, null, !0)),
            !(
              f ||
              (!(
                this.panEnabled &&
                r.scaleBreaks &&
                r.scaleBreaks._appliedBreaks.length
              ) &&
                ((r.logarithmic && v < Math.pow(r.dataInfo.minDiff, 3)) ||
                  (!r.logarithmic && v < 3 * Math.abs(r.dataInfo.minDiff)))) ||
              q < r.minimum ||
              g > r.maximum
            ))
          )
            B.push(r), n.push({ val1: q, val2: g }), (l = !0);
          else if (!e) {
            l = !1;
            break;
          }
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var h = this._indexLabels[a],
          ...
          r,
          q,
          l = ka("indexLabelFontColor", h.dataPoint, h.dataSeries),
          B = ka("indexLabelFontSize", h.dataPoint, h.dataSeries);
        r = ka("indexLabelFontFamily", h.dataPoint, h.dataSeries);
        q = ka("indexLabelFontStyle", h.dataPoint, h.dataSeries);
        var p = ka("indexLabelFontWeight", h.dataPoint, h.dataSeries),
          g = ka("indexLabelBackgroundColor", h.dataPoint, h.dataSeries),
          e = ka("indexLabelMaxWidth", h.dataPoint, h.dataSeries),
          f = ka("indexLabelWrap", h.dataPoint, h.dataSeries),
          v = ka("indexLabelLineDashType", h.dataPoint, h.dataSeries),
          k = ka("indexLabelLineColor", h.dataPoint, h.dataSeries),
          m = s(h.dataPoint.indexLabelLineThickness)
        ...
        var F = h.dataPoint.indexLabelFormatter
          ...
          : null;
        if (null !== F && "" !== F) {
          var t = ka("indexLabelPlacement", h.dataPoint, h.dataSeries),
            x = ka("indexLabelOrientation", h.dataPoint, h.dataSeries),
            C = h.direction,
            A = h.dataSeries.axisX,
            z = h.dataSeries.axisY,
            w = !1,
            g = new ia(d, {
              x: 0,
              y: 0,
              maxWidth: e ? e : 0.5 * this.width,
              maxHeight: f ? 5 * B : 1.5 * B,
          ...
          if ("stackedarea100" === n) {
            ...
            if (
              h.dataPoint.x < A.viewportMinimum ||
              h.dataPoint.x > A.viewportMaximum ||
              Math.max.apply(null, h.dataPoint.y) < z.viewportMinimum ||
              Math.min.apply(null, h.dataPoint.y) > z.viewportMaximum
            )
              continue;
          } else if (
            0 <= n.indexOf("line") ||
            ...
            if (
              h.dataPoint.x < A.viewportMinimum ||
              h.dataPoint.x > A.viewportMaximum ||
              h.dataPoint.y < z.viewportMinimum ||
              h.dataPoint.y > z.viewportMaximum
            )
              continue;
          } else if (
            0 <= n.indexOf("column") ||
            "waterfall" === n ||
            ("error" === n && !h.axisSwapped)
          ) {
            if (
              h.dataPoint.x < A.viewportMinimum ||
              h.dataPoint.x > A.viewportMaximum ||
          ...
          e = p = 2;
          "horizontal" === x
            ? ((l = g.width), (B = g.height))
            : ((B = g.width), (l = g.height));
              ...
              : ((e = Math.max(h.bounds.y1, c.y1)),
                ...
                (b =
                  0 <= n.indexOf("range") || "error" === n
                    ? 0 < C
                      ? Math.max(h.bounds.y1, c.y1) + B / 2 + p
                      : Math.min(h.bounds.y2, c.y2) - B / 2 - p
                    : (Math.max(h.bounds.y1, c.y1) +
                        Math.min(h.bounds.y2, c.y2)) /
                      2),
                0 < C
                  ? ((q = Math.max(h.point.y, b) - B / 2),
                    q < e &&
                      ("bubble" === n || "scatter" === n) &&
                      (q = Math.max(h.point.y - B - p, c.y1 + p)))
                  : ((q = Math.min(h.point.y, b) - B / 2),
                    q > f - B - p &&
                      ("bubble" === n || "scatter" === n) &&
                      (q = Math.min(h.point.y + p, c.y2 - B - p))),
                (q = Math.min(q, f - B)));
          } else
            0 <= n.indexOf("line") ||
            0 <= n.indexOf("area") ||
                  ...
                  0 > C
                    ...
                    : ((r = h.point.x + e + b),
                      r > f - l - e - b &&
                        ((r =
                          "auto" === t
                            ? Math.min(h.point.x, f) - l - e - b
                            : f - l - e - b),
                        (w = r < h.point.x))))
                : ((p = Math.max(h.bounds.x1, c.x1)),
                  Math.min(h.bounds.x2, c.x2),
                  (b =
                    0 <= n.indexOf("range") || "error" === n
                      ? 0 > C
                        ? Math.max(h.bounds.x1, c.x1) + l / 2 + e
                        : Math.min(h.bounds.x2, c.x2) - l / 2 - e
                      : (Math.max(h.bounds.x1, c.x1) +
                          Math.min(h.bounds.x2, c.x2)) /
                        2),
                  (r =
                    0 > C
                      ? Math.max(h.point.x, b) - l / 2
                      : Math.min(h.point.x, b) - l / 2),
                  (r = Math.max(r, p)));
          "vertical" === x && (q += B);
          g.x = r;
          g.y = q;
          ...
          m &&
            ...
            0 <= n.indexOf("bar") || ("error" === n && h.axisSwapped)
              ? d.lineTo(
                  r + (0 < h.direction ? 0 : l),
                  q + ("horizontal" === x ? B : -B) / 2
                )
              : 0 <= n.indexOf("column") || ("error" === n && !h.axisSwapped)
              ? d.lineTo(
                  r + l / 2,
                  q +
                    ((0 < h.direction ? B : -B) +
              ...
              : d.lineTo(
                  r + l / 2,
                  q +
                    ((q < h.point.y ? B : -B) + ("horizontal" === x ? B : -B)) /
                      2
                ),
            d.stroke());
        }
    ...
    m.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          var v = h._colorSet,
            k = (v = h.lineColor = h.options.lineColor
              ? h.options.lineColor
              : v[0]);
          c.strokeStyle = v;
          var m = !0,
                  ...
                  m || C
                    ? (!m && h.connectNullData
                        ? (c.setLineDash &&
                            ...
                            c.beginPath(),
                            c.moveTo(p.x, p.y),
                            (r = h.nullDataLineDashType),
                            c.setLineDash(q)),
                          c.lineTo(x, s),
                          u && b.lineTo(x, s))
                        : (c.beginPath(),
                          c.moveTo(x, s),
                          u && (b.beginPath(), b.moveTo(x, s))),
                      (C = m = !1))
                    : (c.lineTo(x, s),
                      u && b.lineTo(x, s),
                      0 == t % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(x, s),
                        u && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                  p = { x: x, y: s };
                  t < n.length - 1 &&
                    (k !== (n[t].lineColor || v) ||
                      r !== (n[t].lineDashType || h.lineDashType)) &&
                    (c.stroke(),
                    c.beginPath(),
                    c.moveTo(x, s),
                    (k = n[t].lineColor || v),
                    ...
                    c.setLineDash &&
                      (n[t].lineDashType
                        ? ((r = n[t].lineDashType),
                          c.setLineDash(N(r, h.lineThickness)))
                        : ((r = h.lineDashType), c.setLineDash(g))));
                  if (0 < n[t].markerSize || 0 < h.markerSize) {
                    var z = h.getMarkerProperties(t, x, s, c);
                    f.push(z);
                    A = P(A);
                    u &&
                      f.push({
                  ...
                  t < n.length - 1 &&
                    ...
                    c.setLineDash &&
                      (n[t].lineDashType
                        ...
                        : ((r = h.lineDashType), c.setLineDash(g))));
                  if (0 < n[t].markerSize || 0 < h.markerSize)
                    (A = h.getMarkerProperties(t, x, s, c)),
                      f.push(A),
                      (z = P(z)),
                      u &&
                        f.push({
            ...
            for (x = !1, m = 0; m < n.length; m++)
              if (
                ...
                if ("number" !== typeof n[m].y)
                  ...
                  m < n.length - 1 &&
                    (k !== (n[m].lineColor || v) ||
                      r !== (n[m].lineDashType || h.lineDashType)) &&
                    ((k = n[m].lineColor || v),
                    (s[s.length - 1].newStrokeStyle = k),
                    b.setLineDash &&
                      (n[m].lineDashType
                        ? ((r = n[m].lineDashType),
                  ...
                  if (0 < n[m].markerSize || 0 < h.markerSize) {
                    var A = h.getMarkerProperties(m, t, x, b);
                    p.push(A);
                    C = P(C);
                    u &&
                      p.push({
    ...
    m.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        r = this.dataPointWidth = this.options.dataPointWidth
          ? this.dataPointWidth
          : (0.9 *
              ((e.width *
                (a.axisX.logarithmic
        ...
        for (n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < v.length)
            for (
              var k = 5 < r && g.bevelEnabled ? !0 : !1, f = 0;
              f < v.length;
              f++
            )
              if (
                (v[f].getTime ? (B = v[f].x.getTime()) : (B = v[f].x),
                !(
                ...
                (v[f].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    point: {
                      x: p + (m - p) / 2,
                      y: 0 > v[f].y === a.axisY.reversed ? l : t,
                    },
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                if (
                  ...
                  (B[b] = t[h].y + (B[b] ? B[b] : 0)),
                    (A = a.axisY.convertValueToPixel(B[b])),
                    (r = "undefined" !== typeof p[b] ? p[b] : q),
                    (p[b] = A);
                else if (
                  ((r = a.axisY.convertValueToPixel(t[h].y)), 0 <= t[h].y)
                ) {
    ...
    m.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var v = 0; v < a.dataSeriesIndexes.length; v++) {
          ...
          if (0 < t.length)
            for (
              var x = 5 < g && m.bevelEnabled ? !0 : !1, h = 0;
              h < t.length;
              h++
            )
              if (
                ...
                if (
                  ...
                  l[b] = r + ("undefined" !== typeof l[b] ? l[b] : 0);
                  if (0 >= l[b]) continue;
                  r = a.axisY.convertValueToPixel(l[b]);
                  A = f[b] ? f[b] : q;
                  f[b] = r;
                  ...
                  (B[b] = r + ("undefined" !== typeof B[b] ? B[b] : 0)),
                    (A = a.axisY.convertValueToPixel(B[b])),
                    (r = p[b] ? p[b] : q),
                    (p[b] = A);
                  ...
                  r -= z;
                  A = q - z;
                  a.dataSeriesIndexes.length - 1 === v &&
                    1 >= Math.abs(e.y1 - r) &&
                    (r = e.y1);
                  f[b] = z + (A - r);
                } else
          ...
          if (0 < v.length) {
            ...
            for (f = 0; f < v.length; f++)
              if (
                ...
                p = a.axisY.convertValueToPixel(v[f].y);
                l = a.axisX.reversed
                  ? (l +
                      (a.plotType.totalDataSeries * r) / 2 -
                      (a.previousDataSeriesCount + n) * r) <<
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                b = t[h].color
                  ? t[h].color
                  : m._colorSet[h % m._colorSet.length];
                ca(c, A, s, n, C, b, 0, null, x, !1, !1, !1, m.fillOpacity);
                b = m.dataPointIds[h];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                if (
                  ...
                  (B[b] = s + (B[b] ? B[b] : 0)),
                    (n = p[b] ? p[b] : q),
                    (p[b] = s = a.axisY.convertValueToPixel(B[b]));
                else if (((n = a.axisY.convertValueToPixel(s)), 0 <= t[h].y)) {
                  var z = f[b] ? f[b] : 0;
                  s = q + z;
                  n += z;
                  a.dataSeriesIndexes.length - 1 === v &&
                ...
                b = t[h].color
                  ? t[h].color
                  : m._colorSet[h % m._colorSet.length];
                ca(c, s, C, n, A, b, 0, null, x, !1, !1, !1, m.fillOpacity);
                b = m.dataPointIds[h];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
    ...
    m.prototype.renderArea = function (a) {
      ...
      function b() {
        A &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          u && (p.lineTo(m, C), p.lineTo(A.x, C), p.closePath(), p.fill()),
          f.beginPath(),
          f.moveTo(m, t),
          p.beginPath(),
          p.moveTo(m, t),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          var k = 0,
            ...
            A = null;
          if (0 < v.length) {
            var z = g._colorSet[k % g._colorSet.length],
            ...
            for (var ja = !0; k < v.length; k++)
              if (
                ...
                if ("number" !== typeof v[k].y)
                  ...
                  k < v.length - 1 &&
                    (y !== (v[k].lineColor || w) ||
                      c !== (v[k].lineDashType || g.lineDashType)) &&
                    (b(),
                    (y = v[k].lineColor || w),
                    (f.strokeStyle = y),
                    f.setLineDash &&
                  ...
                  0 !== v[k].markerSize &&
                    ...
                    ((s = g.getMarkerProperties(k, m, t, f)),
                    B.push(s),
                    (Z = P(Z)),
                    u &&
                      B.push({
        ...
        for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
          ...
          if (0 < r.length) {
            var F = n._colorSet[q % n._colorSet.length],
              C = (n.lineColor = n.options.lineColor || F),
              A = C;
            b.fillStyle = F;
            b.strokeStyle = C;
            ...
            for (v = !1; q < r.length; q++)
              if (
                ((g = r[q].x.getTime ? r[q].x.getTime() : r[q].x),
                !(
                ...
                if ("number" !== typeof r[q].y)
                  ...
                  v = a.axisY.convertValueToPixel(r[q].y);
                  ...
                  q < r.length - 1 &&
                    (A !== (r[q].lineColor || C) ||
                      z !== (r[q].lineDashType || n.lineDashType)) &&
                    ((A = r[q].lineColor || C),
                  ...
                  if (
                    0 !== r[q].markerSize &&
                    (0 < r[q].markerSize || 0 < n.markerSize)
                  ) {
                    var R = n.getMarkerProperties(q, g, v, b);
                    p.push(R);
                    S = P(S);
                    u &&
                      p.push({
              ...
              if (
                ...
                "number" !== typeof v[k].y
                  ...
                  : ((m = a.axisX.convertValueToPixel(s)),
                    ...
                    k < v.length - 1 &&
                      (y !== (v[k].lineColor || w) ||
                        S !== (v[k].lineDashType || g.lineDashType)) &&
                      (b(),
                      (y = v[k].lineColor || w),
                      (f.strokeStyle = y),
                      f.setLineDash &&
                    ...
                    0 !== v[k].markerSize &&
                      (0 < v[k].markerSize || 0 < g.markerSize) &&
                      ((Z = g.getMarkerProperties(k, m, t, f)),
                      B.push(Z),
                      (s = P(s)),
                      u &&
                        B.push({
    ...
    m.prototype.renderStackedArea = function (a) {
      function d() {
        if (!(1 > h.length)) {
          for (0 < z.lineThickness && b.stroke(); 0 < h.length; ) {
            var a = h.pop();
            b.lineTo(a.x, a.y);
            u && s.lineTo(a.x, a.y);
          }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
          var A = a.dataSeriesIndexes[C],
            z = this.data[A],
            w = z.dataPoints;
          z.dataPointIndexes = [];
          for (q = 0; q < w.length; q++)
            (A = w[q].x.getTime ? w[q].x.getTime() : w[q].x),
              (z.dataPointIndexes[A] = q),
              e[A] || (n.push(A), (e[A] = !0));
          n.sort(Na);
        }
        for (C = 0; C < a.dataSeriesIndexes.length; C++) {
          A = a.dataSeriesIndexes[C];
          z = this.data[A];
          w = z.dataPoints;
          x = !0;
          h = [];
          ...
          if (0 < n.length) {
            ...
            F = "solid";
            if (b.setLineDash) {
              var R = N(z.nullDataLineDashType, z.lineThickness);
              F = z.lineDashType;
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  if (
                    ...
                    v = a.axisY.convertValueToPixel(r[f]);
                  } else (v = a.axisY.convertValueToPixel(fa.y)), (v -= la);
                  h.push({ x: g, y: m - la });
                  k[f] = m - v;
                  x || Z
                    ? (!x && z.connectNullData
    ...
    m.prototype.renderStackedArea100 = function (a) {
      function d() {
        ...
        b.globalAlpha = 1;
        b.beginPath();
        u && (F.closePath(), F.fill(), F.beginPath());
        h = [];
      }
      var c = a.targetCanvasCtx || this.plotArea.ctx,
        b = u ? this._preRenderCtx : c;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        b.clip();
        u && (F.beginPath(), F.rect(p.x1, p.y1, p.width, p.height), F.clip());
        for (var e = [], w = 0; w < a.dataSeriesIndexes.length; w++) {
          var A = a.dataSeriesIndexes[w],
            z = this.data[A],
            y = z.dataPoints;
          z.dataPointIndexes = [];
          for (q = 0; q < y.length; q++)
            (A = y[q].x.getTime ? y[q].x.getTime() : y[q].x),
              (z.dataPointIndexes[A] = q),
              e[A] || (n.push(A), (e[A] = !0));
          n.sort(Na);
        }
        for (w = 0; w < a.dataSeriesIndexes.length; w++) {
          A = a.dataSeriesIndexes[w];
          z = this.data[A];
          y = z.dataPoints;
          s = !0;
          e = z.id;
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  if (
                    ...
                    if (0 >= r[f] && a.axisY.logarithmic) continue;
                    v = a.axisY.convertValueToPixel(r[f]);
                  } else (v = a.axisY.convertValueToPixel(la)), (v -= ba);
                  h.push({ x: g, y: x - ba });
                  k[f] = x - v;
                  s || Z
                    ? (!s && z.connectNullData
                  ...
                  0 <= z.dataPointIndexes[f] &&
                    0 !== fa.markerSize &&
                    (0 < fa.markerSize || 0 < z.markerSize) &&
                    ((ba = z.getMarkerProperties(q, g, v, b)),
                    l.push(ba),
                    (f = P(G)),
                    u &&
                      l.push({
    ...
    m.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < x.length)
            for (
              var F = 5 < v && t.bevelEnabled ? !0 : !1, l = 0;
              l < x.length;
              l++
            )
              if (
                ...
                var C = (k - v / 2) << 0,
                  ...
                  z = Math.round(Math.max(1, 0.15 * v)),
                  y = 0 === z % 2 ? 0 : 0.5,
                  D = t.dataPointIds[l];
                ...
                "candlestick" === t.type
                  ? (c.moveTo(k - y, n),
                    ...
                    ca(
                      ...
                      A,
                      Math.max(h, q),
                      x[l].y[0] <= x[l].y[3] ? t.risingColor : f,
                      z,
                      e,
                      F,
                      F,
                ...
                (x[l].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: x[l],
                    dataSeries: t,
                    point: { x: C + (A - C) / 2, y: a.axisY.reversed ? r : n },
                    direction: 1,
                    bounds: {
                      x1: C,
                      y1: Math.min(n, r),
    ...
    m.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          if (0 < F.length)
            for (
              var C = 5 < v && x.bevelEnabled ? !0 : !1, p = 0;
              p < F.length;
              p++
            )
              if (
                (F[p].getTime ? (g = F[p].x.getTime()) : (g = F[p].x),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) &&
                  ...
                  "number" === typeof F[p].y[4] &&
                  5 === F[p].y.length)
              ) {
                l = a.axisX.convertValueToPixel(g);
                k = a.axisY.convertValueToPixel(F[p].y[0]);
                h = a.axisY.convertValueToPixel(F[p].y[1]);
                n = a.axisY.convertValueToPixel(F[p].y[2]);
                r = a.axisY.convertValueToPixel(F[p].y[3]);
                q = a.axisY.convertValueToPixel(F[p].y[4]);
                var A = (l - v / 2) << 0,
                  z = (l + v / 2) << 0,
                  e = F[p].color ? F[p].color : x._colorSet[0],
                  ...
                  S = F[p].whiskerColor
                    ...
                    : e,
                  R =
                    "number" === typeof F[p].whiskerThickness
                      ? F[p].whiskerThickness
                      : "number" === typeof x.options.whiskerThickness
                      ? x.whiskerThickness
                      : y,
                  E = F[p].whiskerDashType
                    ? F[p].whiskerDashType
                    : x.whiskerDashType,
                  ...
                  la = F[p].stemColor
                    ...
                    : e,
                  ba =
                    "number" === typeof F[p].stemThickness
                      ? F[p].stemThickness
                      : "number" === typeof x.options.stemThickness
                      ? x.stemThickness
                      : y,
                  G = 1 === Math.round(ba) % 2 ? 0.5 : 0,
                  J = F[p].stemDashType ? F[p].stemDashType : x.stemDashType,
                  I = F[p].lineColor
                    ? F[p].lineColor
                    : F[p].color
                    ? x.lineColor
                    ...
                    : e,
                  M =
                    "number" === typeof F[p].lineThickness
                      ? F[p].lineThickness
                      : "number" === typeof x.options.lineThickness
                      ? x.lineThickness
                      : y,
                  Q = F[p].lineDashType ? F[p].lineDashType : x.lineDashType,
                  K = 1 === Math.round(M) % 2 ? 0.5 : 0,
                  V = x.upperBoxColor,
                  va = x.lowerBoxColor,
                  qa = s(x.options.fillOpacity) ? 1 : x.fillOpacity,
                  O = x.dataPointIds[p];
                ...
                0 < M &&
                  (c.beginPath(),
                  (c.globalAlpha = 1),
                  c.setLineDash && c.setLineDash(N(Q, M)),
                  (c.strokeStyle = I),
                  (c.lineWidth = M),
                  c.moveTo(A, q - K),
                  c.lineTo(z, q - K),
                ...
                0 < R &&
                  (c.beginPath(),
                  c.setLineDash && c.setLineDash(N(E, R)),
                  (c.strokeStyle = S),
                  (c.lineWidth = R),
                  c.moveTo((l - Z / 2) << 0, r - fa),
                  c.lineTo((l + Z / 2) << 0, r - fa),
                  c.stroke(),
                  c.moveTo((l - Z / 2) << 0, k + fa),
                  c.lineTo((l + Z / 2) << 0, k + fa),
                  c.stroke());
                c.restore();
                u &&
                  ((e = P(O)),
                  ...
                  0 < ba &&
                    (b.moveTo(l - D - G, h),
                    b.lineTo(l - D - G, Math.max(k, r)),
                    b.stroke(),
                    b.moveTo(l - D - G, Math.min(k, r)),
                    b.lineTo(l - D - G, n),
                    b.stroke()),
                  ca(
                    b,
                ...
                (F[p].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: F[p],
                    dataSeries: x,
                    point: { x: A + (z - A) / 2, y: a.axisY.reversed ? k : r },
                    direction: 1,
                    bounds: {
                      x1: A,
                      y1: Math.min(k, r),
    ...
    m.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < g.length)
            for (
              var v = 5 < h && q.bevelEnabled ? !0 : !1, f = 0;
              f < g.length;
              f++
            )
              if (
                ...
                var m = a.axisX.reversed
                    ? (b +
                        ...
                        (a.previousDataSeriesCount + n) * h) <<
                      0
                    : (b -
                        (a.plotType.totalDataSeries * h) / 2 +
                        (a.previousDataSeriesCount + n) * h) <<
                      0,
                  w = a.axisX.reversed ? (m - h) << 0 : (m + h) << 0,
                  b = g[f].color
                    ? g[f].color
                ...
                ca(c, m, p, w, l, b, 0, b, v, v, !1, !1, q.fillOpacity);
                b = P(t);
                u &&
                  ca(
                    this._eventManager.ghostCtx,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
          var F = a.dataSeriesIndexes[x],
            ...
            D = 0;
          if (z)
            for (e = C._linkedSeries.id, t = 0; t < e; t++)
              !this.data[t].type.match(/(bar|column)/gi) ||
                !this.data[t].visible ||
          ...
          t > l && (t = l);
          if (0 < A.length)
            for (var E = C._colorSet, l = 0; l < A.length; l++) {
              var e = (C.lineColor = C.options.color ? C.options.color : E[0]),
                S = {
                  color: A[l].whiskerColor
                    ? A[l].whiskerColor
                    : A[l].color
                    ? C.whiskerColor
                      ? C.whiskerColor
                    ...
                    ? C.whiskerColor
                    : e,
                  thickness: s(A[l].whiskerThickness)
                    ? C.whiskerThickness
                    : A[l].whiskerThickness,
                  dashType: A[l].whiskerDashType
                    ? A[l].whiskerDashType
                    : C.whiskerDashType,
                  length: s(A[l].whiskerLength)
                    ? s(C.options.whiskerLength)
                      ? t
                      : C.options.whiskerLength
                    : A[l].whiskerLength,
                  trimLength: s(A[l].whiskerLength)
                    ? s(C.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
              ...
              var R = {
                color: A[l].stemColor
                  ...
                  ? C.stemColor
                  : e,
                thickness: A[l].stemThickness
                  ? A[l].stemThickness
                  : C.stemThickness,
                dashType: A[l].stemDashType
                  ? A[l].stemDashType
                  : C.stemDashType,
              };
              R.thickness =
                "number" === typeof R.thickness
                  ...
                  : 2;
              A[l].getTime ? (v = A[l].x.getTime()) : (v = A[l].x);
              if (
                !(
                ...
                var ja = a.axisX.convertValueToPixel(v);
                b ? (h = ja) : (k = ja);
                ja = a.axisY.convertValueToPixel(A[l].y[0]);
                b ? (n = ja) : (q = ja);
                ja = a.axisY.convertValueToPixel(A[l].y[1]);
                b ? (r = ja) : (g = ja);
                b
                  ? ((q = a.axisX.reversed
                  ...
                  : ((n = a.axisX.reversed
                      ...
                      : (k - ((z ? w : 1) * t) / 2 + (z ? D - 1 : 0) * t) << 0),
                    (r = a.axisX.reversed ? (n - t) << 0 : (n + t) << 0));
                !b && q > g && ((ja = q), (q = g), (g = ja));
                b && n > r && ((ja = n), (n = r), (r = ja));
                ja = C.dataPointIds[l];
                ...
                if (
                  ...
                  this._indexLabels.push({
                    ...
                    indexKeyword: 0,
                    point: {
                      x: b ? (A[l].y[1] >= A[l].y[0] ? n : r) : n + (r - n) / 2,
                      y: b ? q + (g - q) / 2 : A[l].y[1] >= A[l].y[0] ? g : q,
                    },
                    direction: A[l].y[1] >= A[l].y[0] ? -1 : 1,
                    bounds: {
                      x1: b ? Math.min(n, r) : n,
                      y1: b ? q : Math.min(q, g),
                      x2: b ? Math.max(n, r) : r,
                      ...
                      point: {
                        x: b
                          ? A[l].y[1] >= A[l].y[0]
                            ...
                            : n
                          : n + (r - n) / 2,
                        y: b ? q + (g - q) / 2 : A[l].y[1] >= A[l].y[0] ? q : g,
                      },
                      direction: A[l].y[1] >= A[l].y[0] ? 1 : -1,
                      bounds: {
                        x1: b ? Math.min(n, r) : n,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < v.length) {
            ...
            for (f = 0; f < v.length; f++)
              if (
                (v[f].getTime ? (h = v[f].x.getTime()) : (h = v[f].x),
                !(
                  ...
                  !s(v[f].y) &&
                  v[f].y.length &&
                  "number" === typeof v[f].y[0] &&
                  "number" === typeof v[f].y[1])
              ) {
                p = a.axisY.convertValueToPixel(v[f].y[0]);
                l = a.axisY.convertValueToPixel(v[f].y[1]);
                k = a.axisX.convertValueToPixel(h);
                k = a.axisX.reversed
                  ? (k +
                      (a.plotType.totalDataSeries * n) / 2 -
                      (a.previousDataSeriesCount + r) * n) <<
                    0
                  : (k -
                      (a.plotType.totalDataSeries * n) / 2 +
                      (a.previousDataSeriesCount + r) * n) <<
                    0;
                var w = a.axisX.reversed ? (k - n) << 0 : (k + n) << 0;
                p > l && ((b = p), (p = l), (l = b));
                b = v[f].color
                  ? v[f].color
                  : g._colorSet[f % g._colorSet.length];
                ca(c, p, k, l, w, b, 0, null, m, !1, !1, !1, g.fillOpacity);
                b = g.dataPointIds[f];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
                ...
                if (
                  ...
                  this._indexLabels.push({
                    ...
                    indexKeyword: 0,
                    point: {
                      x: v[f].y[1] >= v[f].y[0] ? p : l,
                      y: k + (w - k) / 2,
                    },
                    direction: v[f].y[1] >= v[f].y[0] ? -1 : 1,
                    bounds: {
                      x1: Math.min(p, l),
                      y1: k,
                      x2: Math.max(p, l),
        ...
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < r.length) {
            var w = n._colorSet[g % n._colorSet.length],
              C = (n.lineColor = n.options.lineColor || w),
              A = C;
            b.fillStyle = w;
            b.strokeStyle = C;
            b.lineWidth = n.lineThickness;
            ...
            for (var S = !0; g < r.length; g++)
              if (
                ((t = r[g].x.getTime ? r[g].x.getTime() : r[g].x),
                !(
                  t < a.axisX.dataInfo.viewPortMin ||
                  (t > a.axisX.dataInfo.viewPortMax &&
                    (!n.connectNullData || !S))
                ...
                if (
                  null !== r[g].y &&
                  r[g].y.length &&
                  "number" === typeof r[g].y[0] &&
                  "number" === typeof r[g].y[1]
                ) {
                  v = a.axisX.convertValueToPixel(t);
                  m = a.axisY.convertValueToPixel(r[g].y[0]);
                  s = a.axisY.convertValueToPixel(r[g].y[1]);
                  q || S
                    ? (n.connectNullData && !q
                        ? (b.setLineDash &&
                            (n.options.nullDataLineDashType ||
                            ...
                            ((k[k.length - 1].newLineDashArray = D),
                            (z = n.nullDataLineDashType),
                            b.setLineDash(y)),
                          b.lineTo(v, m),
                          u && e.lineTo(v, m),
                  ...
                  g < r.length - 1 &&
                    (A !== (r[g].lineColor || C) ||
                      z !== (r[g].lineDashType || n.lineDashType)) &&
                    (d(),
                    (A = r[g].lineColor || C),
                    (k[k.length - 1].newStrokeStyle = A),
                    (b.strokeStyle = A),
                    b.setLineDash &&
                      (r[g].lineDashType
                        ? ((z = r[g].lineDashType),
                  ...
                  if (
                    0 !== r[g].markerSize &&
                    (0 < r[g].markerSize || 0 < n.markerSize)
                  ) {
                    var R = n.getMarkerProperties(g, v, s, b);
                    f.push(R);
                    var E = P(t);
                    u &&
                      f.push({
                    ...
                    R = n.getMarkerProperties(g, v, m, b);
                    f.push(R);
                    E = P(t);
                    u &&
                      f.push({
                  ...
                  if (
                    ...
                    this._indexLabels.push({
                      ...
                      point: { x: v, y: m },
                      direction:
                        r[g].y[0] > r[g].y[1] === a.axisY.reversed ? -1 : 1,
                      color: w,
                    }),
                      this._indexLabels.push({
                        chartType: "rangeArea",
        ...
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < n.length) {
            ...
            var C = "solid",
              A;
            if (b.setLineDash) {
              var z = N(h.nullDataLineDashType, h.lineThickness),
                C = h.lineDashType;
              A = N(C, h.lineThickness);
            }
            for (g = !1; r < n.length; r++)
              if (
                ((q = n[r].x.getTime ? n[r].x.getTime() : n[r].x),
                !(
                ...
                if (
                  null !== n[r].y &&
                  n[r].y.length &&
                  "number" === typeof n[r].y[0] &&
                  "number" === typeof n[r].y[1]
                ) {
                  ...
                  r < n.length - 1 &&
                    (F !== (n[r].lineColor || x) ||
                      C !== (n[r].lineDashType || h.lineDashType)) &&
                    ((F = n[r].lineColor || x),
                  ...
                  if (
                    0 !== n[r].markerSize &&
                    (0 < n[r].markerSize || 0 < h.markerSize)
                  ) {
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < w.length)
            for (
              ...
              if (
                (w[p].getTime ? (n = w[p].x.getTime()) : (n = w[p].x),
                "number" !== typeof w[p].y)
              ) {
                if (0 < p && !C && s.connectNullData)
                  var y =
                    s.options.nullDataLineDashType || !w[p - 1].lineDashType
                ...
                var S = w[p].color
                  ...
                  ? s.risingColor
                  : s.fallingColor;
                ca(c, l, k, D, h, S, 0, S, F, F, !1, !1, s.fillOpacity);
                e = P(e);
                u &&
                  ca(
                    this._eventManager.ghostCtx,
                ...
                var R,
                  S = l;
                R =
                  ("undefined" !== typeof w[p].isIntermediateSum &&
                    !0 === w[p].isIntermediateSum) ||
                  ("undefined" !== typeof w[p].isCumulativeSum &&
                    !0 === w[p].isCumulativeSum)
                    ? 0 < w[p].y
                      ? k
                      : h
                    : 0 < w[p].y
                ...
                0 < p &&
                  A &&
                  (!C || s.connectNullData) &&
                  (C && c.setLineDash && c.setLineDash(N(y, t)),
                  c.beginPath(),
                  c.moveTo(A, z - x),
                  c.lineTo(S, R - x),
                  0 < t && c.stroke(),
                ...
                (w[p].indexLabel ||
                  s.indexLabel ||
                  w[p].indexLabelFormatter ||
                  s.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: "waterfall",
                    dataPoint: w[p],
                    dataSeries: s,
                    point: { x: l + (D - l) / 2, y: 0 <= w[p].y ? k : h },
    ...
    m.prototype.renderPie = function (a) {
      function d() {
        if (h && n) {
          ...
          for (e = 0; e < n.length; e++)
            (l = g[(c + e) % n.length]),
              1 < a &&
                l.midAngle > Math.PI / 2 - t &&
                l.midAngle < Math.PI / 2 + t &&
                (f <= a / 2 && !r
                  ? ((l.hemisphere = "right"), f++)
                  : ((l.hemisphere = "left"), (r = !0)));
          r = !1;
          for (e = 0; e < n.length; e++)
            (l = g[(d + e) % n.length]),
              1 < b &&
        ...
        for (b = 0; b < n.length; b++) {
          ...
          if (d > c) {
            ...
            Y(
              ...
              g[b].center,
              g[b].radius,
              n[b].color ? n[b].color : h._colorSet[b % h._colorSet.length],
              h.type,
              c,
              d,
              h.fillOpacity,
          ...
          (c = g[b]),
            c.indexLabelText &&
              ...
              "inside" !== c.indexLabelPlacement &&
                ...
                a.lineTo(
                  c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -r : r),
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < n.length) {
          var k = g[a];
          if (
            (0 > c && k.indexLabelTextBlock.y < l) ||
            (0 < c && k.indexLabelTextBlock.y > p)
          )
            return 0;
          var q = 0,
            r = 0,
            r = (q = q = 0);
          0 > c
            ? k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 > l &&
          ...
          l =
            "right" === k.hemisphere
              ? F.x + Math.sqrt(Math.pow(u, 2) - Math.pow(c - F.y, 2))
              : F.x - Math.sqrt(Math.pow(u, 2) - Math.pow(c - F.y, 2));
          r = F.x + z * Math.cos(k.midAngle);
          q = F.y + z * Math.sin(k.midAngle);
          q = Math.sqrt(Math.pow(l - r, 2) + Math.pow(c - q, 2));
          r = Math.acos(z / u);
          ...
          h &&
            ...
            (c =
              "right" === k.hemisphere
                ? F.x + Math.sqrt(Math.pow(u, 2) - Math.pow(d - F.y, 2))
                : F.x - Math.sqrt(Math.pow(u, 2) - Math.pow(d - F.y, 2))),
            k.midAngle > Math.PI / 2 - t && k.midAngle < Math.PI / 2 + t
            ...
            (k.indexLabelAngle = Math.atan2(
              k.indexLabelTextBlock.y - F.y,
              k.indexLabelTextBlock.x - F.x
            )));
        }
        return h;
      }
        ...
        for (
          ...
          if ("inside" !== h.indexLabelPlacement) {
            ...
            for (a = 0; a < n.length; a++) {
              var p = g[a];
              p.indexLabelTextBlock.x = F.x + u * Math.cos(p.midAngle);
              p.indexLabelTextBlock.y = F.y + u * Math.sin(p.midAngle);
            ...
            for (var t, s, a = 0; a < n.length; a++) {
              ...
              if (null !== A) {
                ...
                var y = 0,
                  y = b(t, s) - m;
                if (0 > y) {
                  for (var C = (s = 0), J = 0; J < n.length; J++)
                    J !== a &&
                      g[J].hemisphere === p.hemisphere &&
                      (g[J].indexLabelTextBlock.y < p.indexLabelTextBlock.y
                        ? s++
                        : C++);
                  s = (y / (s + C || 1)) * C;
                  var C = -1 * (y - s),
            ...
            for (a = 0; a < n.length; a++)
              (p = g[a]),
                (u = "pie" === h.type ? 0.7 * z : 0.8 * z),
                (A = F.x + u * Math.cos(p.midAngle)),
                (s = F.y + u * Math.sin(p.midAngle)),
                (p.indexLabelTextBlock.x = A),
                (p.indexLabelTextBlock.y = s);
          for (a = 0; a < n.length; a++)
            if (
              ((p = g[a]),
              (A = p.indexLabelTextBlock.measureText()),
              0 !== A.height && 0 !== A.width)
            )
              (A = A = 0),
                "right" === p.hemisphere
                  ? ((A =
                ...
                0 < A &&
                  (!l &&
                    ...
                    ((s =
                      "right" === p.hemisphere
                        ? q.x2 - p.indexLabelTextBlock.x
                        : p.indexLabelTextBlock.x - q.x1),
                    0.3 * p.indexLabelTextBlock.maxWidth > s
                      ? (p.indexLabelText = "")
                      : (p.indexLabelTextBlock.maxWidth = 0.85 * s),
                    0.3 * p.indexLabelTextBlock.maxWidth < s &&
                      (p.indexLabelTextBlock.x -=
                  ...
                  ((A /= Math.abs(Math.cos(p.indexLabelAngle))),
                  9 < A && (A *= 0.3),
                  A > d && (d = A)),
                (A = A = 0),
                0 < p.indexLabelAngle && p.indexLabelAngle < Math.PI
                  ? ((A =
                      q.y2 -
                      (p.indexLabelTextBlock.y +
                        p.indexLabelTextBlock.height / 2 +
                  ...
                  (!l &&
                    ...
                    ((s =
                      0 < p.indexLabelAngle && p.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === f(a, A * s) && f(a, 2 * s)),
                  Math.abs(p.indexLabelTextBlock.x - F.x) < z &&
                    ((A /= Math.abs(Math.sin(p.indexLabelAngle))),
                    9 < A && (A *= 0.3),
                    A > d && (d = A)));
              ...
              if (((f = !1), (t = g[h]), t.indexLabelText)) {
                ...
                if (null !== p) {
                  ...
                  k
                    ? (0 > a && (a = h),
                      p !== a && ((c = p), (d += -y)),
                      0 === h % Math.max(n.length / 10, 3) && (f = !0))
                    : (f = !0);
                  f &&
                    0 < d &&
                    0 <= a &&
    ...
    m.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        if (0 === g) return -1;
        for (
          var p = (d[0] = 0), l = 0, k, n, b = b - a, p = !1, h = 0;
          h < x.length;
          h++
        )
        ...
        if (t && x) {
          for (
            ...
            (m = O[z]),
              ...
              (v[z] = M - m - V);
          m = 0.5 * V;
          for (var z = 0, F = x.length - 1; z < x.length || 0 <= F; z++, F--) {
            b = t.reversed ? x[F] : x[z];
            a = b.color
              ? b.color
              : t.reversed
            ...
            r = b.indexLabelMaxWidth
              ...
              : v[z];
            if (r > v[z] || 0 > r) r = v[z];
            B[z] = "inside" === t.indexLabelPlacement ? O[z].height : !1;
            ...
            c = new ia(P, {
              ...
              backgroundColor: d,
              maxWidth: r,
              maxHeight: !1 === B[z] ? (q ? 4.28571429 * f : 1.5 * f) : B[z],
              text: b,
              padding: da,
            });
            c.measureText();
        ...
        if (e)
          for (l = H.length - 1; 0 <= l; l--)
            (a = O[l]),
              ...
              t.reversed
                ? (H[l].textBlock.y + H[l].height > T + C &&
                    (H[l].textBlock.y = T + C - H[l].height),
                  H[l].textBlock.y < qa - C && (H[l].textBlock.y = qa - C))
                : (H[l].textBlock.y < T - C && (H[l].textBlock.y = T - C),
                  H[l].textBlock.y + H[l].height > qa + C &&
                    (H[l].textBlock.y = qa + C - H[l].height));
      }
      function f() {
        var a, b, c, d;
          ...
          for (var e = 0; e < O.length; e++)
            0 == H[e].textBlock.text.length
              ...
              : ((a = O[e]),
                ...
                t.reversed
                  ? (H[e].textBlock.y + H[e].height > T + C &&
                      (H[e].textBlock.y = T + C - H[e].height),
                    H[e].textBlock.y < qa - C && (H[e].textBlock.y = qa - C))
                  : (H[e].textBlock.y < T - C && (H[e].textBlock.y = T - C),
                    H[e].textBlock.y + H[e].height > qa + C &&
                      (H[e].textBlock.y = qa + C - H[e].height)));
        else
      ...
      function p() {
        ...
        function b() {
          ...
          for (var l, p = 1; p < h; p++) {
            ...
            for (var n = H.length - 1; 0 <= n; n--)
              !H[n].isDirty &&
                H[n].textBlock.y < e &&
                H[n].textBlock.y + H[n].height > e &&
                ((l = q(n)),
                !(l >= H.length - 1) &&
                  H[n].textBlock.y + H[n].height + da > H[l].textBlock.y &&
                  (H[n].textBlock.y =
                    H[n].textBlock.y + H[n].height - e > e - H[n].textBlock.y
                      ? e + 1
                      : e - H[n].height - 1));
          }
        ...
        for (var d, e, f, g, h, p, k = 1, n = 0; n < 2 * k; n++) {
          for (
            ...
            (f = H[m]),
            (g = f.textBlock),
            (p = (h = q(m) < O.length ? H[q(m)] : null) ? h.textBlock : null),
      ...
      function l(a, b) {
        return (
          (b < O.length ? H[b].textBlock.y : t.reversed ? T + C : qa + C) -
          (0 > a
            ? t.reversed
              ? qa - C
              : T - C
          ...
          changeSection: function (a) {
            for (var b, c, d = 0; d < O.length; d++)
              (b = g[d]),
                (c = O[d]),
                (b *= a),
                "undefined" === typeof r[d] && (r[d] = 0),
                0 > r && (r *= -1),
                (c.y1 += b - r[d]),
                (c.y2 += b - r[d]),
                (c.y3 += b - r[d]),
                (c.y4 += b - r[d]),
                c.y5 && ((c.y5 += b - r[d]), (c.y6 += b - r[d])),
                (r[d] = b);
          },
        };
        a._animator.animate(
          ...
          function (c) {
            ...
            for (e = 0; e < O.length; e++) oa(d, O[e], t.fillOpacity);
            w(d);
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var t = this.data[a.dataSeriesIndexes[0]],
            ...
            z = 0,
            D = F.height - 2 * C,
            E = Math.min(F.width - 2 * A, 2.8 * F.height),
            I = !1,
            R = 0;
          R < x.length;
          R++
          ...
          if (
            (!I &&
              "undefined" !== typeof x[R].indexLabel &&
              null !== x[R].indexLabel &&
              0 < x[R].indexLabel.toString().length &&
              (I = !0),
            !I &&
              "undefined" !== typeof x[R].label &&
              null !== x[R].label &&
              0 < x[R].label.toString().length &&
              (I = !0),
            (!I && "function" === typeof t.indexLabelFormatter) ||
              "function" === typeof x[R].indexLabelFormatter)
          )
            I = !0;
        I =
          I ||
        ...
        if (0 != t.length && t.dataPoints && t.visible && 0 !== x.length) {
          ...
          if (-1 !== R) {
            if (t.reversed)
              for (E.push(U), G = R.length - 1; 0 < G; G--)
                (U += R[G]), E.push(U);
            else for (G = 0; G < R.length; G++) (U += R[G]), E.push(U);
            if (t.reversed)
              for (G = 0; G < R.length; G++)
                E[G] < va
                  ? (a.push(K), A.push(X), (ca = G))
                  : (a.push((E[G] - T + aa * W) / aa),
                    A.push((E[G] - T + ea * $) / ea));
            else
              for (G = 0; G < R.length; G++)
                E[G] < va
            ...
            for (G = 0; G < x.length; G++)
              x[G].exploded &&
                ((R = !0), t.reversed ? Y.push(x.length - 1 - G) : Y.push(G));
            P.clearRect(F.x1, F.y1, F.width, F.height);
            P.fillStyle = y.backgroundColor;
            P.fillRect(F.x1, F.y1, F.width, F.height);
            if (
              I &&
              t.visible &&
            ...
            for (G = 0; G < O.length; G++)
              (z = O[G]), oa(P, z, t.fillOpacity), ga.push(z.y1);
            w(P);
            I &&
              t.visible &&
              ("inside" === t.indexLabelPlacement || y.animationEnabled || n(P),
            ...
            !y.animationEnabled && R
              ? k(y, -1, 0)
              : y.animationEnabled && !y.animatedRender && k(y, -1, 0);
            ...
            return {
              ...
              animationCallback: function (a, b) {
                ...
                1 <= a && (k(y, -1, 500), w(y.plotArea.ctx || y.ctx));
              },
              easingFunction: L.easing.easeInQuad,
              animationBase: 0,
            };
    ...
    m.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
        ...
        try {
          var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
          g && 0 < g.length && ((h = Da(g[2])), (a = Da(g[1])));
        } catch (l) {}
        g = null;
        if ("color" === a)
      ...
      for (var n = 0; n < this.dataSeries.length; n++) {
        ...
        if (r.dataPoints && r.dataPoints.length)
          if (
            ...
            var q = (r.legendMarkerType = r.legendMarkerType
                ? r.legendMarkerType
                : ("line" !== r.type &&
                    "stepLine" !== r.type &&
                    "spline" !== r.type &&
                    ...
                    "bubble" !== r.type) ||
                  !r.markerType
                ? "error" === r.type && r._linkedSeries
                  ? r._linkedSeries.legendMarkerType
                    ? r._linkedSeries.legendMarkerType
                    : I.getDefaultLegendMarker(r._linkedSeries.type)
              ...
              g = r.legendText
                ...
                : r.name,
              m = (r.legendMarkerColor = r.legendMarkerColor
                ? r.legendMarkerColor
                : r.markerColor
                ? r.markerColor
                : "error" === r.type
              ...
              u =
                ...
                ("line" !== r.type &&
                  ...
                  : 0,
              w = r.legendMarkerBorderColor
                ? r.legendMarkerBorderColor
                : r.markerBorderColor,
              t = r.legendMarkerBorderThickness
            ...
            for (var x = 0; x < r.dataPoints.length; x++) {
              var y = r.dataPoints[x],
                ...
                m = y.legendMarkerColor
                  ...
                  : r.color
                  ? r.color
                  : r._colorSet[x % r._colorSet.length],
                ...
                t = y.legendMarkerBorderThickness
                  ...
                  : r.legendMarkerBorderThickness
                  ? r.legendMarkerBorderThickness
                  : y.markerBorderThickness || r.markerBorderThickness
                  ? Math.max(1, Math.round(0.2 * u))
                  : 0,
                g = this.chart.replaceKeywordsWithValue(g, y, r, x),
                q = {
                  markerType: q,
                  markerColor: m,
                  text: g,
              ...
              (y.showInLegend || (r.showInLegend && !1 !== y.showInLegend)) &&
                k.push(q);
            }
      }
            ...
            if ("horizontal" === this.orientation) {
                ...
                r.width +
                  Math.round(
                    q.textBlock.width +
                      u +
                      l +
                      (0 === r.width ? 0 : this.horizontalSpacing) +
                      ("line" === q.chartType ||
                      "spline" === q.chartType ||
                      "stepLine" === q.chartType
                        ? 2 * 0.1 * this.lineHeight
              ...
              (q.textBlock = new ia(this.ctx, {
                ...
                this.height < p - this.lineHeight
                  ? ((r = { items: [], width: 0 }), h.push(r))
                  : ((r = h[x]), (x = (x + 1) % h.length)),
    ...
    E.prototype.render = function () {
      ...
      for (var l = 0, k = 0; k < p.length; k++) {
        for (var h = p[k], n = 0, r = 0; r < h.items.length; r++) {
          var q = h.items[r],
            g =
              q.textBlock.x + a + (0 === r ? 0.2 * f : this.horizontalSpacing),
            m = d + l,
            s = g;
      ...
      for (;;) {
        ...
        if (0 <= f && f < this.dataPoints.length) {
          var b = this.dataPoints[f],
            r = this.axisX.logarithmic
              ? b.x > a
                ? b.x / a
                : a / b.x
              : Math.abs(b.x - a);
          r < c.distance &&
            ((c.dataPoint = b), (c.distance = r), (c.index = f));
          b = r;
          b <= l ? (l = b) : 0 < p ? k++ : h++;
                ...
                ? Math.min(
                    Math.max(
                      (((this.dataPoints.length - 1) / q) *
                        Math.log(r / this.dataPoints[0].x)) >>
                        0,
                      0
                    ),
                    this.dataPoints.length
        ...
        for (
          ...
          a ||
            ((a = this.labelFormatter
              ...
              : "axisX" === this.type && this.labels[n]
              ? this.labels[n]
              : ya(n, this.valueFormatString, this.chart._cultureInfo)),
            (a = new ia(this.ctx, {
              x: 0,
              y: 0,
              maxWidth: f,
                  ...
                  (n =
                    0 != this.labelAngle
                      ? (h -
                        ...
                        Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))
                      : f),
                  (this.sessionVariables.labelMaxHeight = p = this.labelWrap
                    ? (h -
                        n *
                          Math.sin(
                            (Math.PI / 180) * Math.abs(this.labelAngle)
          ...
          (p =
            ...
            s(f.labelBackgroundColor) &&
              (s(f.startValue) && 0 !== f.startValue
                ? (f.labelBackgroundColor = u ? "transparent" : null)
    ...
    D.setLayout = function (a, d, c, b, e, f) {
      ...
      for (g = 0; g < q.length; g++)
        if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
          for (
            var m = q[g].scaleBreaks._appliedBreaks, u = 0;
            u < m.length && !(m[u].startValue > q[g].viewportMaximum);
            u++
          )
            m[u].endValue < q[g].viewportMinimum ||
              (s(q[g].scaleBreaks.firstBreakIndex) &&
                (q[g].scaleBreaks.firstBreakIndex = u),
              m[u].startValue >= q[g].viewPortMinimum &&
                (q[g].scaleBreaks.lastBreakIndex = u));
      for (
        var w = (u = 0),
          t = 0,
          x = 0,
      ...
      if ("normal" === e) {
        for (
          ...
          k = Math.round(
            f.x2 - aa - $ > n.width - r ? n.width - r : f.x2 - aa - $
          );
          if (a && 0 < a.length)
            for (x = [], g = U = 0; g < a.length; g++)
              a[g] && (a[g].lineCoordinates = {}),
                (a[g].lineCoordinates.width = Math.abs(k - p)),
                a[g].title &&
          ...
          M.push(x);
          if (d && 0 < d.length)
            for (y = [], g = X = 0; g < d.length; g++)
              d[g] && (d[g].lineCoordinates = {}),
                (d[g].lineCoordinates.width = Math.abs(k - p)),
                d[g].title &&
                ...
                (X += y[g]),
                (Y += d[g] && !n.isNavigator ? d[g].margin : 0);
          else
            ...
            for (g = 0; g < a.length; g++)
              a[g] &&
                ...
                n.panEnabled
                  ...
                  : (n.sessionVariables.axisX.height = U),
                (l = Math.round(f.y2 - U - e + G)),
                (h = Math.round(f.y2)),
                (a[g].lineCoordinates.x2 = k),
                (a[g].lineCoordinates.width = k - p),
                (a[g].lineCoordinates.y1 = l),
                (a[g].lineCoordinates.y2 = l + a[g].lineThickness / 2),
          ...
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++)
              (d[g].lineCoordinates.x1 = Math.round(f.x1 + O + K)),
                ...
                (d[g].lineCoordinates.y1 = l + X + Y - V),
                (d[g].lineCoordinates.y2 = l),
              ...
              b[g] &&
                ...
                (K =
                  b[g]._labels && 0 < b[g]._labels.length
                    ...
                    : 0),
                (l = Math.round(
                  f.y1 + X + Y < Math.max(K, r) ? Math.max(K, r) : f.y1 + X + Y
                )),
                (K =
                  0 < a.length
                    ? 0
            ...
            for (g = 0; g < a.length; g++)
              a[g] &&
                ...
                a[g]._labels &&
                  ...
                  (p = a[g].getApparentDifference(a[g].viewportMinimum, p)),
                  (D = a[g].logarithmic
                    ? (1 < p
                        ? (Math.log(p) /
                            a[g].conversionParameters.lnLogarithmBase) *
                    ...
                    : (0 < p
                        ? p * Math.abs(a[g].conversionParameters.pixelPerUnit)
                        : 0) + a[g].lineCoordinates.x1)));
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++)
              d[g].calculateValueToPixelConversionParameters(),
                ...
                d[g]._labels &&
                  ...
                  (p = d[g].getApparentDifference(d[g].viewportMinimum, p)),
                  (D = d[g].logarithmic
                    ? (1 < p
                        ? (Math.log(p) /
                            d[g].conversionParameters.lnLogarithmBase) *
                    ...
                    : (0 < p
                        ? p * Math.abs(d[g].conversionParameters.pixelPerUnit)
                        : 0) + d[g].lineCoordinates.x1));
          for (g = 0; g < q.length; g++)
            "axisY" === q[g].type &&
        ...
        for (N = []; 4 > u; ) {
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                (p = Math.round(f.x1 + W + e)),
                (k = Math.round(
                  f.x2 - U - Y > n.width - 10 ? n.width - 10 : f.x2 - U - Y
                )),
                c[g].labelAutoFit &&
                  !s(x) &&
                  (0 < !a.length &&
                  ...
                  0 < !d.length &&
                    (k =
                      0 < c[g].labelAngle
                        ...
                        ? k - y / 2
                        : k)),
                (c[g].lineCoordinates.x1 = p),
                (c[g].lineCoordinates.x2 = k),
                (c[g].lineCoordinates.width = Math.abs(k - p)),
                c[g].title &&
                  (c[g]._titleTextBlock.maxWidth =
                    0 < c[g].titleMaxWidth &&
                  ...
                  (0 < !a.length &&
                    (p =
                      0 < b[g].labelAngle
                        ...
                        : p),
                  0 < !d.length && (k -= A / 2)),
                (b[g].lineCoordinates.x1 = p),
                (b[g].lineCoordinates.x2 = k),
                (b[g].lineCoordinates.width = Math.abs(k - p)),
                b[g].title &&
                  (b[g]._titleTextBlock.maxWidth =
                    0 < b[g].titleMaxWidth &&
          ...
          if (c && 0 < c.length)
            ...
            r.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
          D.push(r);
          if (b && 0 < b.length)
            for (z = [], g = V = 0; g < b.length; g++)
              z.push(
          ...
          if (n.panEnabled)
            for (g = 0; g < c.length; g++)
              r[g] = s(n.sessionVariables.axisY.height)
                ? (n.sessionVariables.axisY.height = r[g])
          ...
          if (c && 0 < c.length)
            for (g = c.length - 1; 0 <= g; g--)
              (l = Math.round(f.y2)),
                ...
                (c[g].lineCoordinates.y1 = l - (r[g] + c[g].margin + X)),
                (c[g].lineCoordinates.y2 = l - (r[g] + c[g].margin + X)),
                "inside" === c[g].labelPlacement &&
                  0 < g &&
          ...
          if (b && 0 < b.length)
            for (g = b.length - 1; 0 <= g; g--)
              b[g] &&
                ((l = Math.round(f.y1)),
                (h = Math.round(f.y1 + (z[g] + b[g].margin + G))),
            ...
            for (g = 0; g < a.length; g++) {
              ...
              if (b && 0 < b.length)
                for (K = 0; K < b.length; K++)
                  b[K] &&
                    b[K].labelAutoFit &&
                    ((k = b[K].lineCoordinates.x1), (p = k - W));
              a[g].lineCoordinates = {
                x1: k - P,
                y1: l,
                x2: k - P,
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length)
                for (K = 0; K < b.length; K++)
                  b[K] &&
                    b[K].labelAutoFit &&
                    ((k = b[K].lineCoordinates.x2), (p = k - U));
              d[g].lineCoordinates = {
                x1: k + Q,
                y1: l,
                x2: k + Q,
    ...
    D.render = function (a, d, c, b, e) {
      ...
      if (d && 0 < d.length)
        for (l = 0; l < d.length; l++)
          d[l].renderGrid(),
            u && (d[l].createMask(), d[l].renderBreaksBackground());
      if (c && 0 < c.length)
        for (l = 0; l < c.length; l++)
          c[l].renderGrid(),
            u && (c[l].createMask(), c[l].renderBreaksBackground());
      if (b && 0 < b.length)
        for (l = 0; l < b.length; l++)
          b[l].renderGrid(),
    ...
    D.prototype.calculateBreaksSizeInValues = function () {
      for (
        ...
        (e = b || !s(d[f].options.spacing)),
          (d[f].spacing =
            Pa(d[f].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0),
        ...
        if ("bottom" === this._position || "top" === this._position)
          if (
            ...
            for (
              ...
              r.position > this.viewportMaximum ||
                !(
                  h === this._labels.length - 1 ||
                  k < (Math.log(l / r.position) * m) / e
                ) ||
                (c.push(r),
                (l = r.position),
                (k =
            ...
            for (h = 0; h < this._labels.length; h++)
              (r = this._labels[h]),
                r.position < this.viewportMinimum ||
                  ((k =
                    r.textBlock.width *
                      Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) +
                    r.textBlock.height *
      ...
      if ("bottom" === this._position) {
        for (h = 0; h < this._labels.length; h++)
          (r = this._labels[h]),
            r.position < this.viewportMinimum ||
              r.position > this.viewportMaximum ||
              ((q = this.getPixelCoordinatesOnAxis(r.position)),
              this.tickThickness &&
            ...
            function () {
              for (h = 0; h < a._labels.length; h++)
                if (
                  ((r = a._labels[h]),
                  !(
                    r.position < a.viewportMinimum ||
                    r.position > a.viewportMaximum
                  ) &&
                    ((q = a.getPixelCoordinatesOnAxis(r.position)),
                    a.tickThickness))
                ) {
                        ...
                        ? 0 < this.labelAngle
                          ...
                          : q.x -
                            r.textBlock.width *
                              Math.cos((Math.PI / 180) * this.labelAngle)
                        : q.x +
                          (r.textBlock.height - this.labelFontSize) *
                            Math.sin((Math.PI / 180) * this.labelAngle) -
                          (0 < this.labelAngle
                            ? r.textBlock.width *
                              Math.cos((Math.PI / 180) * this.labelAngle)
                    ...
                    (r.textBlock.x =
                      "inside" === this.labelPlacement
                        ...
                        : q.x -
                          r.textBlock.width *
                            Math.cos((Math.PI / 180) * this.labelAngle) +
                          (r.textBlock.height - r.textBlock.fontSize / 2 - 5) *
                            Math.sin((Math.PI / 180) * this.labelAngle) -
                          ("inside" === this.tickPlacement
                            ? 0
                            : this.tickLength)))));
        ...
        if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
          if (s(this.scaleBreaks.lastBreakIndex))
            ...
            for (
              ...
              d.moveTo(k, e),
                d.lineTo(k, this.scaleBreaks._appliedBreaks[l].startPixel + b),
    ...
    D.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      k = Math.pow(
        this.logarithmBase,
        D.getNiceNumber(Math.abs(Math.log(k) / d), !1)
      );
      this.options && 0 < this.options.interval
        ? (this.interval = this.options.interval)
        : ((this.interval = D.getNiceExponent(Math.log(k) / d / (a - 1), !0)),
    ...
    U.prototype.createUserOptions = function (a) {
      if ("undefined" !== typeof a || this.options._isPlaceholder) {
        ...
        this.options._isPlaceholder ||
          (Aa(this.parent[this.optionsName]),
    ...
    U.prototype.render = function (a) {
      if (
        ...
        if (
          ...
          if (
            ((b = 1 === r % 2 ? (b.x << 0) + 0.5 : b.x << 0),
            (k = 1 === r % 2 ? (e.x << 0) + 0.5 : e.x << 0),
            "top" === this.scaleBreaks.parent._position
              ? ((e = this.chart.plotArea.y1),
                (l = (this.chart.plotArea.y2 + r / 2 + 0.5) << 0))
              : ((e = this.chart.plotArea.y2),
                (l = (this.chart.plotArea.y1 - r / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: b - r / 2, y1: e, x2: k + r / 2, y2: l }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
              ("top" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("bottom" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(b, l), this.ctx.lineTo(k, l), this.ctx.lineTo(k, e);
          ...
          if (
            ((e = 1 === r % 2 ? (e.y << 0) + 0.5 : e.y << 0),
            (l = 1 === r % 2 ? (b.y << 0) + 0.5 : b.y << 0),
            "left" === this.scaleBreaks.parent._position
              ? ((b = this.chart.plotArea.x1),
                (k = (this.chart.plotArea.x2 + r / 2 + 0.5) << 0))
              : ((b = this.chart.plotArea.x2),
                (k = (this.chart.plotArea.x1 - r / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: b, y1: e - r / 2, x2: k, y2: l + r / 2 }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
              ("left" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("right" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(k, e), this.ctx.lineTo(k, l), this.ctx.lineTo(b, l);
          else if ("wavy" === this.type) {
            m = b;
            h = e;
            f = 0.5;
      ...
      if (0 < d) {
        ...
        if (
          ...
          (e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
            ...
            (this.bounds = { x1: e - d / 2, y1: k, x2: f + d / 2, y2: l });
        else if (
          ...
          (k = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
            ...
            (this.bounds = { x1: e, y1: k - d / 2, x2: f, y2: l + d / 2 });
        this.ctx.moveTo(e, k);
        this.ctx.lineTo(f, l);
        this.ctx.stroke();
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          if (
            ...
            v = this.parent.dataSeries[0].axisX.convertPixelToValue({ y: d });
          else if (
            "left" === this.parent._position ||
            "right" === this.parent._position
          )
            v = this.parent.convertPixelToValue({ y: d });
          for (var w = 0; w < this.parent.dataSeries.length; w++)
            (u = this.parent.dataSeries[w].getDataPointAtX(v, !0)) &&
              0 <= u.index &&
              ((u.dataSeries = this.parent.dataSeries[w]),
              null !== u.dataPoint.y && u.dataSeries.visible && n.push(u));
          u = null;
          ...
          if (
            ...
            for (
              ...
              if (n[v].dataPoint.y && n[v].dataPoint.y.length)
                for (var x = 0; x < n[v].dataPoint.y.length; x++)
                  (t = Math.abs(
                    a - this.parent.convertValueToPixel(n[v].dataPoint.y[x])
                  )),
                    t < u && ((u = t), (w = v));
              else
                (t = Math.abs(
                  a - this.parent.convertValueToPixel(n[v].dataPoint.y)
                )),
                  t < u && ((u = t), (w = v));
            ...
            for (
              ...
              if (n[v].dataPoint.y && n[v].dataPoint.y.length)
                for (x = 0; x < n[v].dataPoint.y.length; x++)
                  (t = Math.abs(
                    a - this.parent.convertValueToPixel(n[v].dataPoint.y[x])
                  )),
                    t < u && ((u = t), (w = v));
            ...
            for (
              ...
              if (n[v].dataPoint.y && n[v].dataPoint.y.length)
                ...
                (y += n[v].dataPoint.y),
                  (C = n[v].dataPoint.x.getTime
                    ? n[v].dataPoint.x.getTime()
                    : n[v].dataPoint.x),
                  (C = 100 * (y / n[v].dataSeries.plotUnit.dataPointYSums[C])),
          ...
          if (
            ...
            if (
              ...
              for (v = t = 0; v < x.dataPoint.y.length; v++)
                (t = Math.abs(
                  a - this.parent.convertValueToPixel(x.dataPoint.y[v])
                )),
                  t < u && ((u = t), (b = v));
              l =
                1 === q.lineWidth % 2
            ...
            if (this.parent.labels)
              for (
                n = Math.ceil(this.parent.interval), v = 0;
                v < this.parent.viewportMaximum;
                v += n
              )
          ...
          if (C) {
            if ("axisX" === this.parent.type)
              for (
                v = this.parent.convertPixelToValue({ x: a }), u = null, w = 0;
                w < this.parent.dataSeries.length;
                w++
              )
                (u = this.parent.dataSeries[w].getDataPointAtX(v, !0)) &&
          ...
          !s(this.parent.dataSeries) &&
            ...
            (v = this.parent.dataSeries[0].axisX.convertPixelToValue({ x: a }));
          for (w = 0; w < this.parent.dataSeries.length; w++)
            (u = this.parent.dataSeries[w].getDataPointAtX(v, !0)) &&
              0 <= u.index &&
              ((u.dataSeries = this.parent.dataSeries[w]),
          ...
          if (
            ...
            for (
              ...
              if (n[v].dataPoint.y && n[v].dataPoint.y.length)
                for (x = 0; x < n[v].dataPoint.y.length; x++)
                  (t = Math.abs(
                    d - this.parent.convertValueToPixel(n[v].dataPoint.y[x])
                  )),
                    t < u && ((u = t), (w = v));
              else
                (t = Math.abs(
                  d - this.parent.convertValueToPixel(n[v].dataPoint.y)
                )),
                  t < u && ((u = t), (w = v));
          else if (
          ...
          if (
            ...
            for (v = t = 0; v < x.dataPoint.y.length; v++)
              (t = Math.abs(
                d - this.parent.convertValueToPixel(x.dataPoint.y[v])
              )),
                t < u && ((u = t), (b = v));
            m =
              1 === q.lineWidth % 2
        ...
        if (
          ...
          (f = k = m = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0),
            (b = this.chart.plotArea.x1),
            (e = this.chart.plotArea.x2),
            (this.bounds = { x1: b, y1: f - r / 2, x2: e, y2: k + r / 2 });
        if ("xySwapped" === this.chart.plotInfo.axisPlacement)
        ...
        "left" === this.parent._position && h.x < this.chart.bounds.x1
          ...
          : "bottom" === this.parent._position &&
            ...
            (h.y = this.chart.bounds.y2 - h.height + h.fontSize / 2 + 2);
        0 < r &&
          (q.moveTo(b, f), q.lineTo(e, k), q.stroke(), (this._hidden = !1));
        q.restore();
        !s(h.text) &&
          ("number" === typeof h.text.valueOf() || 0 < h.text.length) &&
          h.render(!0);
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (
          ...
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var m = 0; m < this.chart.axisX.length; m++) {
                for (
                  var k = this.chart.axisX[m].convertPixelToValue({ y: d }),
                    h = null,
                    b = 0;
            ...
            if (this.chart.axisX)
              for (m = 0; m < this.chart.axisX.length; m++)
                for (
                  k = this.chart.axisX[m].convertPixelToValue({ x: a }),
                    h = null,
                    b = 0;
                  b < this.chart.axisX[m].dataSeries.length;
                  b++
            ...
            if (this.chart.axisX2)
              for (m = 0; m < this.chart.axisX2.length; m++)
                for (
                  k = this.chart.axisX2[m].convertPixelToValue({ x: a }),
                    h = null,
                    b = 0;
          ...
          if ((h = this.chart.getDataPointAtXY(a, d, c)))
            ...
            if (
              ((h = Wa(a, d, this.chart._eventManager.ghostCtx)),
              0 < h &&
    ...
    $.prototype.getToolTipInnerHTML = function (a) {
      ...
      if (
        ...
        for (var m = null, h = "", l = 0; l < a.length; l++)
          (c = a[l].dataSeries),
            (b = a[l].dataPoint),
            (e = a[l].index),
            (f = ""),
